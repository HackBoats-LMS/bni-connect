...
import { LayoutDashboard, Compass, UserCircle, Users, MessageSquare } from 'lucide-react';
...
export function BottomNav() {
  ...
  // Hide bottom nav completely if we are viewing an active chat on mobile
  if (pathname === '/messages' && searchParams.get('chat')) {
    return null;
  }
